...
class PEARLConfig:
    ...
    def __post_init__(self):
        ...
        if self.enable_rolling_continuous_eager_dry_run:
            ...
            if self.enable_rolling_continuous_depth3_commit_ready_only and self.max_rolling_continuous_depth < 3:
                raise ValueError(
            ...
            if self.enable_rolling_continuous_depth4_commit_ready_only and self.max_rolling_continuous_depth < 4:
                raise ValueError(
                    "enable_rolling_continuous_depth4_commit_ready_only requires "
                    "max_rolling_continuous_depth >= 4"
                )
