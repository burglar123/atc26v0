...
def stage_trace_record(
    *,
    ...
    actual_draft_seq_ids: list[int] | None = None,
    target_home_set: list[int] | None = None,
    draft_home_set: list[int] | None = None,
    ...
    record: dict[str, Any] = {
        ...
        "draft_home_set": draft_home_set or [],
...
def run_synthetic() -> int:
    ...
    cases = [
        ...
        (
            "cached_full_continuous_target_candidate_buffer_hit_home_set_divergence_bad",
            synthetic_stage_payload(
                [
                    stage_trace_record(
                        runner_role="target",
        ...
        (
            "cached_full_continuous_target_candidate_buffer_hit_home_set_verify_4",
            synthetic_stage_payload(
                [
                    stage_trace_record(
                        runner_role="target",
        ...
        (
            "cached_full_continuous_target_candidate_buffer_miss_home_set_skip",
            synthetic_stage_payload(
                [
                    stage_trace_record(
                        runner_role="target",
        ...
        (
            "cached_full_continuous_target_candidate_empty_raw_on_one_rank_bad",
            synthetic_stage_payload(
                [
                    stage_trace_record(
                        runner_role="target",
